...
class SubsetGenThresholdBehaviorTest {

    @Test
    void shouldIncludeEachElementWithApproxHalfProbabilityWhenUsingLargeInputSet() {
        int n = 22;
        int samples = 120_000;
    ...
    @Test
    void shouldNotShowDistributionJumpWhenCrossingThresholdFrom21To22() {
        int samples = 200_000;
    ...
    @Test
    void shouldHaveBinomialSizeShapeWhenGenerating22FieldSubsets() {
        int n = 22;
        int samples = 200_000;
