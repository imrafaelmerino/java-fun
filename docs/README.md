...
[![Maven](https://img.shields.io/maven-central/v/com.github.imrafaelmerino/json-values/12.2.0)](https://search.maven.org/artifact/com.github.imrafaelmerino/json-values/12.2.0/jar)
...
Disclaimer: If you are the author of one of the other tested libraries or know an alternative to get a better result, 
...
Java 17 or greater for versions greater than 12.2.0.
