...
class JsArrayOfNumberSuchThatSpec extends AbstractPredicateSpec implements JsValuePredicate,JsArraySpec
{
  ...
  {
    return new JsArrayOfNumberSuchThatSpec(predicate, required, true);
  }

  @Override
  public JsSpec optional()
  {
    return new JsArrayOfNumberSuchThatSpec(predicate, false, nullable);
                              ...
                              )
  {
    ...
    this.isArrayOfNumber=new JsArrayOfNumberSpec(required, nullable);
