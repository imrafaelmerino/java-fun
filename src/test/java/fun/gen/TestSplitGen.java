...
public class TestSplitGen {

    @Test
    public void shouldSplitFromSplittableGenerator() {
    ...
    @Test
    public void shouldSplitFromRandom() {
    ...
    @Test
    public void shouldSplitFromSecureRandom() {
    ...
    @Test
    public void shouldFallbackForGenericRandomGenerator() {
