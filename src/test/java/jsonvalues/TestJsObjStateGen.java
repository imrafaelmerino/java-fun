...
public class TestJsObjStateGen
{
  ...
  public void test_gen()
  {
    ...
    JsObjStateGen a = JsObjStateGen.of("a",
                                       ...
                                       "e",o-> choose(1, 10),
                                       "f", o -> JsGens.arrayOf(JsGens.integer, 10)
                                      );

    TestGenerators.test(a,
                        v -> JsObjSpec.strict("a", JsSpecs.str, "b",
                                              JsSpecs.str, "c",
                                              JsSpecs.str.optional(), "d", any(i->i.isStr() || i.isInt()), "f", arrayOfInt, "e",
                                              integer(i->i>0 && i<11)).test(v.toJsObj()).isEmpty(),
                                              1000);
