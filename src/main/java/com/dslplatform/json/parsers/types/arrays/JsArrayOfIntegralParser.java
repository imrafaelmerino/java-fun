...
import com.dslplatform.json.parsers.types.JsIntegralParser;
...
public final  class JsArrayOfIntegralParser extends JsArrayParser
{

    private JsIntegralParser parser;

    public JsArrayOfIntegralParser(final JsIntegralParser parser)
    {
