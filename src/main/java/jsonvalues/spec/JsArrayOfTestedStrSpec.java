...
class JsArrayOfTestedStrSpec extends AbstractPredicateSpec implements JsValuePredicate,JsArraySpec
{
  ...
  {
    return new JsArrayOfTestedStrSpec(predicate, required, true);
  }

  @Override
  public JsSpec optional()
  {
    return new JsArrayOfTestedStrSpec(predicate, false, nullable);
  }

  @Override
  public SpecParser parser()
  {
    return  ParserFactory.INSTANCE.ofArrayOfStrEachSuchThat(predicate,
                                                            nullable
                                                           );
  }
