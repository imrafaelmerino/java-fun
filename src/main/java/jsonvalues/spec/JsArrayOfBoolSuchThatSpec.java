...
class JsArrayOfBoolSuchThatSpec extends AbstractPredicateSpec implements JsValuePredicate,JsArraySpec
{
  ...
  {
    return new JsArrayOfBoolSuchThatSpec(predicate, required, true);
  }

  @Override
  public JsSpec optional()
  {
    return new JsArrayOfBoolSuchThatSpec(predicate, false, nullable);
                            ...
                            )
  {
    ...
    this.isArrayOfBool = new JsArrayOfBoolSpec(required, nullable);
