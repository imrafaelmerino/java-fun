...
class HighArityTupleGenTest {

    private static final IntPredicate IS_BINARY = n -> n == 0 || n == 1;

    @Test
    void shouldGenerateQuadruplesWhenUsingTuple4Generator() {
    ...
    @Test
    void shouldGenerateQuintuplesWhenUsingTuple5Generator() {
    ...
    @Test
    void shouldGenerateSextuplesWhenUsingTuple6Generator() {
    ...
    @Test
    void shouldValidateNullGeneratorsWhenAnyInputGeneratorIsNull() {
