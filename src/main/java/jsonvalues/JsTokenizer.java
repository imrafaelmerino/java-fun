...
/**
 ...
 that I found in the Javadocs to improve the performance.I did some refactor and
 made the tokenizer to return my JsElem objects directly, instead of the objects defined in the library.
 I prefer not to do further modifications in this class, at least for the moment.
