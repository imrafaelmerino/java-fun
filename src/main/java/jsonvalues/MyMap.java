...
abstract class MyMap<M extends MyMap<M>>
{
     ...
     */
    abstract boolean contains(final String key);
     ...
     */
    abstract JsElem get(final String key);
     ...
     */
    abstract Optional<JsElem> getOptional(final String key);
     ...
     */
    abstract Map.Entry<String, JsElem> head();
     ...
     */
    abstract Iterator<Map.Entry<String, JsElem>> iterator();
     ...
     */
    abstract M tail(final String head);
}
