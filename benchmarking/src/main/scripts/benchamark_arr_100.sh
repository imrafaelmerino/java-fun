...
-jar microbenchmarks.jar -o jmh-log-immutable-vavr_list-100.txt jsonvalues\.benchmark\.immutable\.parsing\.StringToJsArray_100\.vavr_list

java -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -Xloggc:gc-log-immutable-vavr_set-100.log \
-jar microbenchmarks.jar -o jmh-log-immutable-vavr_set-100.txt jsonvalues\.benchmark\.immutable\.parsing\.StringToJsArray_100\.vavr_set

java -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -Xloggc:gc-log-immutable-pcollections_vector-100.log \
-jar microbenchmarks.jar -o jmh-log-immutable-pcollections_vector-100.txt jsonvalues\.benchmark\.immutable\.parsing\.StringToJsArray_100\.pcollections_vector

java -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -Xloggc:gc-log-mutable-jackson-array-100.log \
-jar microbenchmarks.jar -o jmh-log-mutable-jackson-array-100.txt jsonvalues\.benchmark\.mutable\.parsing\.StringToJsArray_100\.jackson

java -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -Xloggc:gc-log-mutable-java_array_list-100.log \
-jar microbenchmarks.jar -o jmh-log-mutable-java_array_list-100.txt jsonvalues\.benchmark\.mutable\.parsing\.StringToJsArray_100\.java_array_list

java -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -Xloggc:gc-log-mutable-java_hash_set-100.log \
-jar microbenchmarks.jar -o jmh-log-mutable-java_hash_set-100.txt jsonvalues\.benchmark\.mutable\.parsing\.StringToJsArray_100\.java_hash_set

java -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -Xloggc:gc-log-mutable-ecollections_list-100.log \
-jar microbenchmarks.jar -o jmh-log-mutable-ecollections_list-100.txt jsonvalues\.benchmark\.mutable\.parsing\.StringToJsArray_100\.ecollections_list